...
<template>
  <div>
    <footer class="footer px-10 py-4 text-primary-content">
      <div class="items-center grid-flow-col">
        ...
        <p>{{ data.WEB_NAME }} ©2021 Created by {{ data.WEB_ADMIN_NAME }} <br><a href="https://beian.miit.gov.cn" target="_blank">{{ data.WEB_ICP }}</a></p>
      </div>
      <div class="md:place-self-center md:justify-self-end">
        <div class="grid grid-flow-col gap-4">
          <a href="https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral">本网站由 <img src="https://media.inyaw.com/icon/%E5%8F%88%E6%8B%8D%E4%BA%91_logo6.png" class="inline h-6" alt="又拍"> 提供CDN加速/云存储服务</a>
